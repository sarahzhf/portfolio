...
// Save your photo to public/profile.jpg and it will appear here automatically.
...
const About = () => {
  ...
  const profileImages = [
    { src: PROFILE_PHOTO, caption: t.journal.caption },
  ];
          ...
          <div className="flex flex-col md:flex-row justify-between items-start max-w-6xl mx-auto gap-8">
            <div className="text-left w-full md:w-auto">
              <div className="ascii-container justify-start text-3xl md:text-4xl lg:text-5xl">
                <AsciiMorphText text={t.hero.greeting} />
              </div>
              <div className="hero-subtitle justify-start text-base md:text-lg lg:text-xl mt-2">
                <div className="flex flex-wrap items-center justify-start">
                  <span className={isDarkMode ? 'hero-subtitle-dark' : 'hero-subtitle-light'}>{t.hero.iam}&nbsp;</span>
            ...
            <div className="w-full md:max-w-2xl lg:max-w-4xl relative z-20 px-1 md:px-0">
              <picture>
                ...
                <img
                  ...
                  alt="Open journal with a photo and a short introduction"
              ...
              {/* Left page: polaroid photo (click to enlarge) */}
              <button
                type="button"
                onClick={() => setShowProfileModal(true)}
                aria-label={t.journal.photoAlt}
              ...
              >
                <img
                  src={PROFILE_PHOTO}
                  alt="Sarah Zahaf"
                  style={{ width: '100%', aspectRatio: '4 / 5', objectFit: 'cover', display: 'block', background: '#ecebe6' }}
                  loading="lazy"
              ...
              {/* Right page: handwritten presentation */}
              <div
                className="absolute"
                style={{
                  right: '7%',
              ...
              >
                <p style={{ fontSize: 'clamp(12px, 3vw, 26px)', marginBottom: '6%' }}>
                  {t.journal.title}
                </p>
                <p style={{ fontSize: 'clamp(8.5px, 2.1vw, 18px)' }}>
                  {t.journal.body}
                </p>
              </div>
            </div>
