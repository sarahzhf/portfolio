...
// Destructure only the icons used below
const {
    Docker,
    GithubLight: Github,
    Postman,
...
const DEFAULT_IMAGES: ImageItem[] = [
    ...
    { src: Postman, alt: "REST APIs / Postman" },
    { src: Streamlit, alt: "Streamlit" },
    { src: TensorFlow, alt: "Machine Learning / TensorFlow" },
    { src: Gemini, alt: "Generative AI / Gemini" },
